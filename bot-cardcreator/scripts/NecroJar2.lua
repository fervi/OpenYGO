...
function c1006.operation(e,tp,eg,ep,ev,re,r,rp)
	local rg=Duel.GetMatchingGroup(c1006.filter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
...
function c1006.sp(e,tp,ct)
	...
	g=g:Filter(c1006.spfilter,nil,e,tp)
